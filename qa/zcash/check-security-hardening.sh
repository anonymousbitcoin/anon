...
test_rpath_runpath "${REPOROOT}/src/anond"
test_rpath_runpath "${REPOROOT}/src/anon-cli"
...
test_fortify_source "${REPOROOT}/src/anond"
test_fortify_source "${REPOROOT}/src/anon-cli"
