...
For instance:
    ...
    $ anond -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/anond.tx.raw
...
From the perspective of anond, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into anond directly. Furthermore, no information is
...
using. anond appends an up-counting sequence number to each
