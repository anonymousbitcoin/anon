...
UniValue getrawtransaction(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "     {\n"
            "       \"value\" : x.xxx,            (numeric) The value in ANON\n"
            "       \"n\" : n,                    (numeric) index\n"
            ...
            "           \"bitcoinaddress\"        (string) anon address\n"
            "           ,...\n"
            "         ]\n"
            "       }\n"
            "     }\n"
            ...
            "     {\n"
            "       \"vpub_old\" : x.xxx,         (numeric) public input value in ANON\n"
            "       \"vpub_new\" : x.xxx,         (numeric) public output value in ANON\n"
...
UniValue createrawtransaction(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\": x.xxx   (numeric, required) The key is the ANON address, the value is the ANON amount\n"
            "      ,...\n"
            "    }\n"
