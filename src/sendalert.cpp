...
// Copyright (c) 2018 The Anon developers
...
./anond -printtoconsole -sendalert
...
void ThreadSendAlert()
{
    ...
    // 180007 : 2.1.0
    // 180008 : 2.2.0
    alert.nMinVer       = 180008;
    alert.nMaxVer       = 180009;
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client is out of date and vulnerable to denial of service. Please update to the most recent version of Anon. More info at: https://github.com/anonymousbitcoin/anon";
