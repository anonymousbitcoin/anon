...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client is out of date and vulnerable to denial of service. Please update to the most recent version of Anonymous Bitcoin. More info at: https://btcprivate.org/";
