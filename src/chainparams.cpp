...
public:
    CMainParams() {
        ...
        nForkStartHeight = 0;
        nForkHeightRange = 0;
        zclassicUtxoStartBlock = 0;
        joinsplitStartBlock = 0;
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("anonMT1", "45.33.13.94"));
        vSeeds.push_back(CDNSSeedData("anonMT2", "45.56.69.11"));
        vSeeds.push_back(CDNSSeedData("anonMT3", "198.58.103.84"));
        vSeeds.push_back(CDNSSeedData("anonMT4", "50.116.27.226"));
        vSeeds.push_back(CDNSSeedData("anonMT5", "198.58.97.186"));
        vSeeds.push_back(CDNSSeedData("anonMT6", "96.126.112.77"));
