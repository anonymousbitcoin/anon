...
SPROUT_PKEY_URL="https://assets.anonfork.io/$SPROUT_PKEY_NAME"
SPROUT_VKEY_URL="https://assets.anonfork.io/$SPROUT_VKEY_NAME"
...
This script will fetch the Anonymous Bitcoin (and Zcash) zkSNARK parameters, and verify
